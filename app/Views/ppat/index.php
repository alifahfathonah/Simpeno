...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <form action="<?php echo base_url('Report/PPAT/(:any)') . '/' . $first_date . '/' . $end_date  ?> " method="POST" enctype="multipart/form-data">
            <div class="row ml-2">
                <div class="col-lg-2">
                ...
                <div class="col-sm-2">
                    <a href="<?php echo base_url('/PPAT/print/') . '/' . $first_date . '/' . $end_date  ?> " target="_blank" class="btn btn-outline btn-danger">
